    ...
    <React.Fragment>
      ...
      <div className={styles.overview_container}>
        ...
        >
          ...
          <h3 className="align-right">{Number(food.value).toFixed(2)} kn</h3>
        </div>
        <div
          className={styles.accounts_textbox}
        ...
        >
          ...
          <h3 className="align-right">
            {Number(goingOut.value).toFixed(2)} kn
          </h3>
        </div>
        <div
          className={styles.accounts_textbox}
        ...
        >
          ...
          <h3 className="align-right">{Number(other.value).toFixed(2)} kn</h3>
        </div>
      </div>
    </React.Fragment>
  );
