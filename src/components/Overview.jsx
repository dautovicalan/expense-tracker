  ...
  return (
    <React.Fragment>
      ...
      <div className={styles.overview_container}>
        <div className={`${styles.accounts_textbox} ${styles.income_textbox}`}>
          <h3 className={`${styles.align_left}`}>Income:</h3>
          <h3 className="align-right">{income.value} kn</h3>
        </div>
        <div
          className={`${styles.accounts_textbox} ${styles.food_textbox}`}
        ...
        <div
          className={`${styles.accounts_textbox} ${styles.goingout_textbox}`}
        ...
        <div
          className={`${styles.accounts_textbox} ${styles.other_textbox}`}
